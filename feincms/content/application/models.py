...
def app_reverse(viewname, urlconf=None, args=None, kwargs=None, *vargs, **vkwargs):
    """
...
class ApplicationContent(models.Model):
    ...
    def initialize_type(cls, APPLICATIONS):
        for i in APPLICATIONS:
            ...
            cls.ALL_APPS_CONFIG[urls] = {"urls": urls, "name": name, "config": app_conf}
        ...
        cls.add_to_class(
            ...
            models.CharField(
                _("application"),
                max_length=100,
                choices=[(c["urls"], c["name"]) for c in cls.ALL_APPS_CONFIG.values()],
            ),
        )
            ...
            def __init__(self, *args, **kwargs):
                ...
                if instance:
                    try:
                        ...
                        self.app_config = cls.ALL_APPS_CONFIG[instance.urlconf_path][
                            "config"
                        ]
                    except KeyError:
                        self.app_config = {}
    ...
    def closest_match(cls, urlconf_path):
        ...
        contents = (
            cls.objects.filter(
                parent__in=page_class.objects.active(), urlconf_path=urlconf_path
            )
            .order_by("pk")
