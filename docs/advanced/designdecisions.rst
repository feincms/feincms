...
them using a lightbox script or something similar? You have to ressort
...
with too much capabilites is a really bad idea. The rich text editor
...
possibilites with an enhanced rich text editor. Once the user grasps
